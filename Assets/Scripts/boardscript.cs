    ...
    void Start()
    {
        for (int x = 0; x < width; x++)
        {
            for (int y = 0; y < height; y++)
            {
                ...
                spaceobj.transform.position = new Vector3((x * spacing) + this.transform.position.x, transform.position.y, (y * spacing) + this.transform.position.z);
                // spaceobj.transform.position = new Vector3(1, 2, 3);

                // spaceobj.transform.position = new Vector3(transform.position.x, transform.position.y, transform.position.z);
